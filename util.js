...
const isUndefined = (exports.isUndefined = function isUndefined(param) {
  if (Object.prototype.toString.call(param) == "[object Undefined]")
    return true;
  return false;
});
 ...
 * @description
 */
const isComparableNumber = (exports.isComparableNumber =
  function isComparableNumber(param) {
...
const getMsgTip = (exports.getMsgTip = function getMsgTip(param) {
  return `But the type of the argument passed in is [${getType(
    param
